      ...
      <div className="flex w-full flex-col items-center justify-center">
        ...
        >
          <AccordionItem value="item-1" className="">
            ...
            <AccordionContent className="flex flex-col gap-3 pt-2 sm:gap-4 sm:pt-3 md:gap-5 md:pt-4">
              <p className="text-sm leading-relaxed sm:text-base md:text-lg">
                UI (User Interface) design focuses on the visual elements and aesthetics of a product, while UX (User
                Experience) design focuses on the overall user journey and how users interact with the product. UI is
                about how it looks, UX is about how it works and feels.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2" className="">
            ...
            <AccordionContent className="flex flex-col gap-3 pt-2 sm:gap-4 sm:pt-3 md:gap-5 md:pt-4">
              <p className="text-sm leading-relaxed sm:text-base md:text-lg">
                We offer flexible pricing models including project-based pricing, hourly rates, and retainer agreements.
                The cost depends on the scope, complexity, and timeline of your project. We&apos;ll provide a detailed
          ...
          <AccordionItem value="item-3" className="">
            ...
            <AccordionContent className="flex flex-col gap-3 pt-2 sm:gap-4 sm:pt-3 md:gap-5 md:pt-4">
              <p className="text-sm leading-relaxed sm:text-base md:text-lg">
                Design project timelines vary based on complexity. A simple website design might take 2-3 weeks, while a
                comprehensive app design could take 6-8 weeks. We&apos;ll provide a detailed timeline during our initial
