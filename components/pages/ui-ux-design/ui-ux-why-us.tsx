  ...
  return (
    <div className="flex w-full flex-col px-20">
      ...
      <div className="mt-10 flex flex-col items-center justify-center">
        <PointLine
          title="1. Appealing design that works"
