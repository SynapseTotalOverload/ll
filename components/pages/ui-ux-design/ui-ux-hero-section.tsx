    ...
    >
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-2 sm:px-4 md:px-6 lg:px-8">
        <div className="flex w-full max-w-[95%] flex-col items-center justify-center gap-4 rounded-sm p-4 text-center sm:max-w-[90%] sm:p-6 md:max-w-[85%] md:p-8 lg:max-w-[80%] lg:p-10 xl:max-w-[75%] xl:p-12">
          <h1 className="custom-font-bricolage text-3xl font-bold leading-tight tracking-tight sm:text-4xl sm:leading-snug md:text-5xl md:leading-normal lg:text-6xl lg:leading-relaxed xl:text-7xl xl:leading-loose">
            UI/UX Design
          </h1>
          <p className="text-sm font-normal leading-relaxed sm:text-base md:text-lg lg:text-xl xl:text-2xl">
