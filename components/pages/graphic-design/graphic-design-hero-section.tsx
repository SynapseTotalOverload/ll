      ...
      <div className="flex w-full flex-col items-center justify-center">
        <div className="flex w-fit max-w-[60%] flex-col items-center justify-center rounded-sm p-8 text-center text-[64px] font-[700]">
          ...
          <span className="text-[20px] font-[400]">
            At LogicCraft, we believe that great design is a collaborative process. Our goal is to not only meet your expectations but to exceed them through a seamless, efficient, and creative approach. Here&apos;s how we do it
          </span>
        </div>
      </div>
