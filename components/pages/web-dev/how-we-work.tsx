...
export default function Process() {
  return (
    <div className="flex w-full flex-col gap-8 px-4 sm:gap-12 sm:px-6 md:gap-16 md:px-8 lg:gap-20 lg:px-12 xl:gap-24 xl:px-16">
      ...
      <div className="small-hero-bg mt-6 flex flex-col items-center justify-center gap-4 rounded-lg p-4 sm:mt-8 sm:gap-6 sm:p-6 md:mt-10 md:gap-8 md:p-8 lg:gap-10 lg:p-10">
